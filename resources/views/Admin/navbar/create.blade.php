...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <h2>
                    @lang('navbar.Create Navbar Section')
                </h2>
            </div>
        </div>
                ...
                <form action="{{ route('dashboard.navbar.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="sectionNameAr" aria-describedby="sectionArabicNameHelp"
                            name="nav_section_name_ar" value="{{ old('nav_section_name_ar') }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="sectionLink" aria-describedby="sectionLinkNameHelp"
                            name="nav_section_link" value="{{ old('nav_section_link') }}">
                    </div>
