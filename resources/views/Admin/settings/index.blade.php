        ...
        <form action="{{ route('dashboard.settings.update', $settings->id) }}" method="POST"
            ...
            <section>
                ...
                <div class="mb-3 col-md-5">
                    ...
                    <input type="text" class="form-control" id="name_ar" aria-describedby="nameHelp" name="web_name_ar"
                        placeholder="{{ __('settings.website name in arabic') }}" value="{{ $settings->web_name_ar }}">
                </div>
                ...
                <div class="mb-3 col-md-5">
                    ...
                    <input type="text" class="form-control" id="name_en" aria-describedby="nameHelp" name="web_name_en"
                        placeholder="{{ __('settings.website name in english') }}" value="{{ $settings->web_name_en }}">
                </div>
                {{-- email --}}
            ...
            <section>
                ...
                <div class="mb-3 col-md-5">
                    ...
                    <input type="text" class="form-control" id="name_en" aria-describedby="nameHelp" name="twitter_link"
                        placeholder="{{ __('settings.twitter_link') }}" value="{{ $settings->twitter_link }}">
                </div>

                {{-- linkedin name --}}
                <div class="mb-3 col-md-5">
                    <label for="name_en" class="form-label">@lang('settings.linkedin_link')</label>
                    <input type="text" class="form-control" id="name_en" aria-describedby="nameHelp" name="linkedin_link"
                        placeholder="{{ __('settings.linkedin_link') }}" value="{{ $settings->linkedin_link }}">
                </div>
            </section>
            <br>
            <br>
