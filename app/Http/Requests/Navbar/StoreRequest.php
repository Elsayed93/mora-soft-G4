...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'nav_section_name_ar' => 'required|min:3|max:100|unique:navbars,nav_section_name_ar',
            'nav_section_name_en' => 'required|min:3|max:100|unique:navbars,nav_section_name_en',
